...
//			
//			 Thread.sleep(5000);
//			driver.findElement(By.xpath("//header/nav[1]/div[1]/div[1]/form[1]/input[1]")).sendKeys("giày nam");
//			
//	
//		
//			
//			
//			TestNGResult.put("2", new Object[] { 1d, "Demo Website not login ", "move to login page","move to login page", "Pass", });
//		} catch (Exception e) {
//			TestNGResult.put("2", new Object[] { 1d, "Demo Website not login ", "Get open","Not move to login page ", "Fail", });
...
//	}
	...
	public void searchcate1() {
		...
		TestNGResult.put("3", new Object[] { 2d, "Search Giày nam", "Show giày name","Giay nam in display", "Pass", });
		
		} catch (Exception e) {
			TestNGResult.put("3", new Object[] {2d, "Search Giày nam", "Show giày name","Giay nam not in display", "Fail", });
			org.testng.Assert.assertTrue(false);
		}
	...
	public void searchcate2() {
		...
		TestNGResult.put("4", new Object[] { 3d, "Search Giày nữ", "Show giày nữ","Giay nữ in display", "Pass", });
			...
			TestNGResult.put("4", new Object[] {3d, "Search Giày nữ", "Show giày nữ","Giay nữ not in display", "Fail", });
			org.testng.Assert.assertTrue(false);
		}
	...
	public void searchcate3() {
		...
		TestNGResult.put("5", new Object[] { 4d, "Search phụ kiện", "Show phụ kiện ","phụ kiện displaying", "Pass", });
		
		} catch (Exception e) {
			TestNGResult.put("5", new Object[] {4d, "Search phụ kiện", "Show phụ kiện ","phụ kiện not in display", "Fail", });
			org.testng.Assert.assertTrue(false);
		}
	...
	public void searchcate4() {
		...
		TestNGResult.put("6", new Object[] { 5d, "Search saleoff", "Show product saleoff ","product sale off is displaying", "Pass", });
		
		} catch (Exception e) {
			TestNGResult.put("6", new Object[] {5d, "Search saleoff", "Show product saleoff  ","product sale off not display", "Fail", });
			org.testng.Assert.assertTrue(false);
		}
	...
	public void filter() {
		...
		TestNGResult.put("7", new Object[] { 6d, "Filer product", "show product ","showproduct", "Pass", });
			...
			TestNGResult.put("7", new Object[] { 6d, "Filer product", "show product ","product not display", "fail", });
			org.testng.Assert.assertTrue(false);
		}
