...
//	}
	...
	public void testRegistration(String username, String password,String fullname, String email, String phone, String address,String roll) throws Exception {
		try {
			...
			driver.findElement(By.xpath("//button[contains(text(),'Tạo mới')]")).click();
			   ...
			   Thread.sleep(10000);
				...
				index++;
				res.put("" + index, new Object[] { index, "Create User ",username,email, password,fullname, "Create is sucess",
