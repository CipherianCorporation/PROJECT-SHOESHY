...
//			driver.get(url);
	...
	public void product() {
	    ...
	    Thread.sleep(2000);
		driver.findElement(By.xpath("//body/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/input[1]")).sendKeys("120000");
		
	    Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='prodStock']")).sendKeys("4");
		Select color = new Select(driver.findElement(By.xpath("//body/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[5]/select[1]")));
		color.selectByVisibleText("BLACK");
	    color.selectByIndex(0);
		
	    Thread.sleep(2000);
		Select size = new Select(driver.findElement(By.xpath("//body/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[6]/select[1]")));
		size.selectByVisibleText("33");
		size.selectByIndex(0);
		
		  Thread.sleep(2000);
		driver.findElement(By.xpath("/html[1]/body[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[7]/div[1]/input[1]")).sendKeys("5");
		
		
	    Thread.sleep(2000);
		Select cate = new Select(driver.findElement(By.xpath("//body/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[8]/select[1]")));
		...
		TestNGResult.put("4", new Object[] { 3d, "Created product", "Create is success","Create is success", "Pass", });
		
		} catch (Exception e) {
			TestNGResult.put("4", new Object[] { 3d, "Created product", "Create is success","Create is success", "Fail", });
			org.testng.Assert.assertTrue(false);
		}
